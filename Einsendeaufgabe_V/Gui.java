...
/**
 * Programmname:    GUI
 * Beschreibung:    Oberfläche und Eventbehandlung des Taschenrechners. Hier wird noch die aeltere Bibliothek AWT verwendet. AWT hat den Vorteil, dass AWT zum Standard gehoert und nichts zusaetzlich installiert werden muss. In Programmieren II werden Sie mit dem modernen JavaFX arbeiten.
...
public class Gui extends Frame implements ActionListener{
	...
	// Label für die Änderungen im Display
	...
	private int z2 = 0;									// 2. eingegebene Zahl
  	private char operation = ' ';						// Zeichen für die Rechenoperation
  	...
  	private String input;								// für die Verarbeitung des Displays

	// Schrifttypen für den Rechner
	Font fDisplay = new Font("fDisplay", Font.BOLD, 27);	// für das Display
	Font fBtn     = new Font("fBtn"    , Font.BOLD, 16);	// für die Buttons


/**
 * Konstruktor
 * aktiviert die Windows Events
...
/**
 * init Methode
 * Erstellung der Oberfläche mit GridLayout
 * ein Display
 *
 */
	public void init () {

		// Einstellungen für das Frame
		...
		// Anhängen der Fonts, Farbe und der Actionlistener an die Buttons
		btn1.setFont(fBtn);
...
/**
 * actionPerformed
 * Eventbehandlung der einzelnen Buttons
 * es wird abgefangen das nich mehr als 8 Zahlen eingegeben werden
 * eine Operation kann nur erfolgen wenn erst ein Zahl eigegeben wurde
 * das Gleichheitszeichen funktioniert erst bei korrekter Eingabe der Zahlen und des Operators
 * nach jeder Rechnung muss die C Taste gedrückt werden
 * @param ActionEvent
 */
	public void actionPerformed(ActionEvent event){
		...
		if (event.getSource() == btnC) {			// beim drücken der C Taste reset
			input = "0";
			display.setText(input);
			operation = ' ';
			berechnet=false;
...
/**
 * pOperation
 * wird ausgeführt wenn ein Operationsbutton gedrückt wurde
 * es wird die erste eigegebene Zahl als int gespeichert
 * das display wird gelöscht
 * und das Flag für die erste Zahl wird gesetzt
 */
...
/**
 * processWindowEvent
 * für die Windowsnachrichten
 * zum Schliessen des Programmes über den X Button
 * @param WindowEvent
 */
